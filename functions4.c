...
//Program converts temperature from fahrenheit to celcius and kelvin
...
{
    float k_temp;
    k_temp = fahr_to_celsius(f_temp) + 273.15; //not a mistake, fahrenheit to celsius function is used 
    return k_temp;
}
